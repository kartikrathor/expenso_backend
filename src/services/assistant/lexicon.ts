...
export const CATEGORY_SYNONYMS: Record<string, string[]> = {
  ...
  bills: [
    'bill', 'bills', 'recharge', 'electricity', 'wifi', 'emi', 'mobile bill', 'current bill',
    'light', 'light bill', 'bijli', 'current', 'gas', 'gas bill', 'lpg', 'cylinder', 'broadband', 'internet',
    'बिल', 'रिचार्ज', 'बिजली', 'लाइट',
    'பில்', 'ரீசார்ஜ்', 'மின்சாரம்',
    'బిల్లు', 'రీఛార్జ్', 'కరెంట్',
  ],
  rent: [
    'rent', 'kiraya', 'house rent', 'pg', 'hostel', 'flat rent',
    'किराया', 'किराये',
    'வாடகை', 'vadagai',
    'అద్దె', 'adde',
  ],
  taxes: [
    'tax', 'taxes', 'gst', 'tds', 'income tax', 'property tax',
    'कर', 'टैक्स',
    'வரி', 'vari',
    'పన్ను', 'pannu',
  ],
  gifts: [
    'gift', 'gifts', 'present', 'birthday gift',
    'उपहार', 'गिफ्ट',
    'பரிசு', 'parisu',
    'బహుమతి', 'bahumathi',
  ],
  donation: [
    'donation', 'donate', 'charity', 'daan', 'ngo',
    'दान', 'डोनेशन',
    'நன்கொடை', 'nankodai',
    'విరాళం', 'viral',
  ],
  ...
  personal_care: [
    'salon', 'spa', 'haircut', 'grooming', 'cosmetics', 'skincare', 'parlour', 'personal care',
    'सैलून', 'हेयरकट',
    'சலூன்', 'saloon',
    'సెలూన్',
  ],
...
export const PERIOD_SYNONYMS: Record<'today' | 'week' | 'month' | 'year' | 'all', string[]> = {
  ...
  all: [
    ...
    'ab tak', 'abtk', 'till now', 'so far', 'forever',
    'அனைத்தும்', 'ellaam',
    'అన్నీ', 'anni', 'మొత్తం',
  ],
};
